...
plotReplicationResults1 <- function(slopeList) {
  ...
  out <-
    tibble(
      paper = rep(c("*Adamczyk and Pitt (2009)*, n = 33<br>Homosexuality disapproval ~ Survival values",
                    "*Alesina et al. (2013)*, n = 75<br>FLFP ~ Traditional plough use",
                    "*Beck et al. (2003)*, n = 69<br>Stock market development ~ Settler mortality",
                    "*Beck et al. (2005)*, n = 45<br>GDP ~ SME sector share",
                    ...
                    "*Skidmore and Toya (2002)*, n = 89<br>GDP growth ~ Log number of natural disasters"), each = 4),
